...
void Engine::run() {
    ...
    while (_isRunning && _window.isOpen()) {
        ...
        // [ lab4.3 ]
        // DO ZAKOMENTOWANIA DLA RYSOWANIA KSZTAŁTÓW
...
void Engine::render() {
    ...
    // DO ODKOMENTOWANIA DLA LAB2 I LAB3 I RYSOWANIA KSZTAŁTÓW
 ...
 //    LineSegment lineA({ 200, 100 }, { 300, 250 });
 ...
 //    std::vector<Point2D> poly = { {50,300}, {100,350}, {150,300}, {200,350} };
 ...
 //
 //    // [lab4.1] TEST
 //    CircleObject circle(sf::Vector2f(50,650), 50, sf::Color::Red);
 //    TriangleObject triangle(sf::Vector2f(200, 600),sf::Vector2f(350, 500),sf::Vector2f(350, 600),sf::Color::Blue);
 //    EllipseObject ellipse(300.f, 700.f, 60.f, 25.f, sf::Color::Cyan);
 //    LineObject line({ 450.f,550.f }, { 550.f,700.f }, sf::Color::Yellow);
 //    PointObject point1(450.f, 700.f, 6.f, sf::Color::Magenta);
 //    RectangleObject rect(100.f, 550.f, 120.f, 80.f, sf::Color::Green);
 //
 //    circle.draw(_window);
